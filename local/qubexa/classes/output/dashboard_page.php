...
final class dashboard_page implements \renderable, \templatable {
    ...
    public function export_for_template($output): array {
        ...
        return array_merge($data, [
            ...
            'classesurl' => \local_qubexa\workspace::page_url('classes')->out(false),
            'lessonsurl' => \local_qubexa\workspace::page_url('lessons')->out(false),
            'calendarurl' => \local_qubexa\workspace::page_url('calendar')->out(false),
            'officeurl' => \local_qubexa\workspace::page_url('office')->out(false),
            'reportsurl' => \local_qubexa\workspace::page_url('reports')->out(false),
            'classeslabel' => get_string('classes', 'local_qubexa'),
            'lessonslabel' => get_string('lessons', 'local_qubexa'),
            'calendarlabel' => get_string('dashboardcalendar', 'local_qubexa'),
            'officelabel' => get_string('office', 'local_qubexa'),
